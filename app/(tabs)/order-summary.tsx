...
import { View, Text, ScrollView, StyleSheet, Alert, Platform, BackHandler } from 'react-native';
...
export default function OrderSummaryScreen() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      console.log('🔵 placeOrder returned:', order);
      ...
      if (order) {
        ...
        Alert.alert('Order Failed', 'Failed to place order. Please check your details and try again.');
      }
    } catch (error: any) {
      setLoading(false);
